<?php
   ...
   echo '<div>';
    ...
    // $get_details = $DB->get_records_sql($ssql);
    ...
    // $info_coursename = "SELECT fullname FROM {course} WHERE id=$courseid";
    // $coursename = $DB->get_records_sql($info_coursename);

    // foreach($coursename as $fullname){
