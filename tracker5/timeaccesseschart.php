...
<head>
    ...
    <title><?php echo 'Time access chart'; ?></title>
...
<div style="width: 200px; min-width: 275px; height: 75px; left: 10px; top: 5px; border-radius: 10px; padding: 10px; border: 2px solid silver; text-align: center;">
    <?php echo 'Day back to now: '; ?>
    <input style="width: 50px;" id = "days" type="number" name="days" min="1" max="<?php echo $maximumdays; ?>" value="<?php echo $days ?>">
    <br>
    <button style="width: 100px;" id="apply"><?php echo 'Apply'; ?></button>
    <br>
    <?php echo 'Maxdays to allow: ' . "<b>" . $maximumdays . "</b>"; ?>
</div>
...
<script type="text/javascript">
    ...
    Highcharts.chart('containerA', {
        ...
        title: {
            text: '<?php echo 'Time access chart'; ?>'
        },
        xAxis: {
            type: 'category',
            labels: {
        ...
        yAxis: {
            min: 0,
            title: {
                text: '<?php echo 'Number of students'; ?>'
            }
        },
        legend: {
            enabled: false
