...
require_once($CFG->dirroot.'/blocks/assignmentmarks/lib.php');
...
$id       = required_param('assignmentmarksid', PARAM_INT);
...
$context = block_assignmentmarks_course_context($courseid);
...
$PAGE->set_url(
    '/blocks/assignmentmarks/grades.php',
    array(
        'assignmentmarksid' => $id,
        'courseid' => $courseid,
        'page' => $page,
        'perpage' => $perpage,
        'group' => $group,
