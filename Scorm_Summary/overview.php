<?php
    ...
    require_once($CFG->dirroot.'/blocks/scormsum/lib.php');
    ...
    $id       = required_param('scormsumid', PARAM_INT);
    ...
    $context = block_scormsum_course_context($courseid);
    ...
    $title = 'Overview of students marks';
    ...
    echo $OUTPUT->container_start('block_scormsum');
        ...
        echo html_writer::start_tag('div');
            echo html_writer::start_tag('form', array('action' =>'overview.php', 'method' => 'post'));
                ...
                echo html_writer::empty_tag('input', array('type' => 'hidden', 'name' => 'scormsumid', 'value' => $id));
